...
function Maiornota($nota1, $nota2, $nota3, $nota4) {
    ...
    if($nota1 > $nota2 && $nota1 > $nota3 && $nota1 > $nota4) {
        $resultado = " Sua maior nota é a Primeira";
    } if ($nota2 > $nota1 && $nota2 > $nota3 && $nota2 > $nota4) {
        $resultado = " Sua maior nota é a Segunda";
    } if($nota3 > $nota1 && $nota3 > $nota2 && $nota3 > $nota4) {
        $resultado = " Sua maior nota é a Terceira";
    } if($nota4 > $nota1 && $nota4 > $nota2 && $nota4 > $nota3) {
        $resultado = " Sua maior nota é a Quarta";
    }
    return $resultado;
}
...
function Menornota($nota1, $nota2, $nota3, $nota4) {
    ...
    if($nota1 < $nota2 && $nota1 < $nota3 && $nota1 < $nota4) {
        $resultado = " Sua menor nota foi a Primeira";
    } if ($nota2 < $nota1 && $nota2 < $nota3 && $nota2 < $nota4) {
        $resultado = " Sua menor nota foi a Segunda";
    } if($nota3 < $nota1 && $nota3 < $nota2 && $nota3 < $nota4) {
        $resultado = " Sua menor nota foi a Terceira";
    } if($nota4 < $nota1 && $nota4 < $nota2 && $nota4 < $nota3) {
        $resultado = " Sua menor nota foi a Quarta";
    }
    return $resultado;
}
